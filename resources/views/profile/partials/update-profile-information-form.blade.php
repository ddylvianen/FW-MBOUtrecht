<section>
    <header>
        ...
        <p class="mt-1 text-sm text-gray-600">
            {{ __("Werk je account gegevens bij.") }}
        </p>
    </header>
    ...
    <form method="post" action="{{ route('profile.update') }}" class="mt-6 space-y-6">
        ...
        <div>
            ...
            <x-text-input id="name" name="name" type="text" class="mt-1 block w-full" :value="old('name', $user->name)" required autocomplete="username" />
                ...
                <div>
                    <p class="text-sm mt-2 text-gray-800">
                        ...
                        <button form="send-verification" class="underline text-sm text-gray-600 hover:text-gray-900 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">
                            {{ __('Klik hier om een nieuwe verificatie email te ontvangen.') }}
                        </button>
                    </p>
